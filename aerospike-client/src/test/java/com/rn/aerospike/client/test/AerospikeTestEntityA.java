...
public class AerospikeTestEntityA implements AerospikeRecordStringKey {
    ...
    private AerospikeTestEntityA(Builder builder) {
        key = builder.key;
    ...
    public static Builder newBuilder(AerospikeTestEntityA copy) {
    ...
    public static final class Builder {
        ...
        public AerospikeTestEntityA build() {
            return new AerospikeTestEntityA(this);
        }
    }
}
